...
public class Execicio5 {
	...
	public static void main(String[] args) {
		...
		for (j = 0; j < 10; j++) {
			...
			for (i = 0; i < 8; i++) {
				System.out.println("Digite a resposta dada pelo aluno " + aluno[j] + " à questão " + (i + 1) + ":");
			...
			System.out.println("A nota do aluno " + aluno[j] + " é: " + nota);
		}
        System.out.println(aprovados);
		System.out.println("A porcentagem de aprovados é " + ((aprovados/10)*100) + "%");
