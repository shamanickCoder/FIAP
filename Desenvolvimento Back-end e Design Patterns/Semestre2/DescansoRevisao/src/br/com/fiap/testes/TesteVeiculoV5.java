...
public class TesteVeiculoV5 {
	...
	public static void main(String[] args) {
		...
		while(JOptionPane.showConfirmDialog(null, "Lançar Acessórios", "Título", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0 && iAcessorio<3){
