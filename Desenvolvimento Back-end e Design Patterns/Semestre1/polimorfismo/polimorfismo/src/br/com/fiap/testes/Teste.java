...
public class Teste {
	...
	public static void main(String[] args) {
	  ...
	  resposta = JOptionPane.showInputDialog("1 para Tecnólogo"+"\n"+"2 para Bacharelado"+"\n"+"3 para Medio");
	  
	  if(resposta.equals("1")){
		obj = new Tecnologo(b("Plano estendido? "), texto("Descrição: "), inteiro("Período: "), real("Mensalidade: "));
		obj.setDuracao(obj);		
	  }	  
	  else if (resposta.equals("2")){
		  obj = new Bacharelado(texto("Projeto: "), inteiro("carga:"),texto("descrição: "), inteiro("período: "), real("Mensalidade"));
		  obj.setDuracao(obj);
	  }
	  else {
		  obj = new Medio(texto("tipo"), texto("descrição"),inteiro("periodo"), real("mensalidade"));
		  obj.setDuracao(obj);
	  }
